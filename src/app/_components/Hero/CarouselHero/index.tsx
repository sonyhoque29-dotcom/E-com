...
const slides: Slide[] = [
  {
    ...
    description:
      'Find the best deals on thousands of products. Quality guaranteed with fast shipping worldwide.',
  ...
  },
  {
    ...
    description:
      'Explore our latest collection of trendy products. Stay ahead of the fashion curve.',
    image: '/static-image.jpg',
